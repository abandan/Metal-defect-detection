...
from datasets.fail.label_name import Label_list
...
model.load_model(abs_path("weights/best.pt", path_type="current"))  # 加载预训练的YOLOv8模型
...
if __name__ == '__main__':  # 如果当前模块是主模块
    ...
    img_path = abs_path("test_media/allium106.jpg")  # 定义图像文件的路径
